...
if __name__ == '__main__':
    for d_call, d_name in datasets.items():
        ...
        # processes.append(p0)
        t1.test_1_no_pca(X, y, knn_k, test_iters_t1, train_iters_t1,
                         dataset, n_classes, n_features_real, training_type, test_size)
        ...
        # processes.append(p1)
        t1.test_1_pca(X, y, knn_k, test_iters_t1, train_iters_t1, dataset,
                      n_classes, n_features_real, training_type, test_size)
        ...
        # processes.append(p2)
        t2.test_2_no_pca(X, y, knn_k, test_iters_t2, train_iters_t2, exp_records_per_class,
                         dataset, n_classes, n_features_real, training_type, test_size)
        ...
        # processes.append(p3)
        t2.test_2_pca(X, y, knn_k, test_iters_t2, train_iters_t2, exp_records_per_class,
                      dataset, n_classes, n_features_real, training_type, test_size)
        ...
        # processes.append(p4)
        t3.test_3_no_pca(X, y, knn_k, test_iters_t3, dataset,
                         n_classes, n_features_real, training_type, test_size)
        ...
        # processes.append(p5)
        t3.test_3_pca(X, y, knn_k, test_iters_t3, dataset,
                      n_classes, n_features_real, training_type, test_size)
        ...
        # processes.append(p6)
        t4.test_4_no_pca(X, y, knn_k, test_iters_t4, exp_records_per_class,
                         dataset, n_classes, n_features_real, training_type, test_size)
        ...
        # processes.append(p7)
        t4.test_4_pca(X, y, knn_k, test_iters_t4, exp_records_per_class,
                      dataset, n_classes, n_features_real, training_type, test_size)
