...
if __name__ == '__main__':
    for enc_type in encodings:
        for d_call, d_name in datasets.items():
            ...
            # processes.append(p0)
            t1.test_1_pca(X, y, knn_k, test_iters_t1, train_iters_t1,
                          d_name, n_classes, 3, training_type, test_size, enc_type, 2)
            ...
            # processes.append(p1)
            t1.test_1_pca(X, y, knn_k, test_iters_t1, train_iters_t1,
                          d_name, n_classes, 5, training_type, test_size, enc_type, 4)
            ...
            # processes.append(p4)
            t3.test_3_pca(X, y, knn_k, test_iters_t3, d_name,
                          n_classes, 3, training_type, test_size, enc_type, 2)
            ...
            # processes.append(p5)
            t3.test_3_pca(X, y, knn_k, test_iters_t3, d_name,
                          n_classes, 5, training_type, test_size, enc_type, 4)
